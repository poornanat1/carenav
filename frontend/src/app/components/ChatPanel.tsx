...
const INTENT_STYLE: Record<string, { border: string; bg: string; text: string }> = {
  member_profile: { border: 'rgba(14,14,9,0.22)', bg: 'rgba(14,14,9,0.045)', text: 'var(--cn-text)' },
  medication: { border: 'rgba(78,122,78,0.35)',  bg: 'rgba(78,122,78,0.06)',  text: 'var(--cn-accent-strong)' },
  benefits:   { border: 'rgba(60,90,140,0.3)',   bg: 'rgba(60,90,140,0.05)',  text: 'var(--cn-info)' },
  ...
  safety:     { border: 'rgba(160,50,50,0.4)',   bg: 'rgba(160,50,50,0.06)',  text: 'var(--cn-danger)' },
};
        ...
        {r && (
          ...
          >
            <MetaPill
              ...
              color={r.grounded ? 'var(--cn-accent)' : 'rgba(14,14,9,0.3)'}
